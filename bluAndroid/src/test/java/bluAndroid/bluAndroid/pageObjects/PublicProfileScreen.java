...
public class PublicProfileScreen {
	...
	{
		WebElement unblock=driver.findElement(By.xpath("//android.widget.LinearLayout[@resource-id='sg.com.blu.android:id/content']//android.widget.LinearLayout[3]//android.widget.TextView[@resource-id='sg.com.blu.android:id/actionTextView']"));
		return unblock;
	}
	...
	{
		WebElement mobile=driver.findElement(By.xpath("//android.widget.HorizontalScrollView[@resource-id='sg.com.blu.android:id/tabLayout']//androidx.appcompat.app.ActionBar.Tab[2]"));
		mobile.click();
	}
}
