...
public class BluLogoutTestRunner extends BaseClass {
	...
	public void tc01_logout()
	{
		...
		ms.logout();
		WebElement logIn=driver.findElement(By.id("sg.com.blu.android:id/log_in_btn"));
		WebElement signup=driver.findElement(By.id("sg.com.blu.android:id/sign_up_btn"));
	...
	public void tc02_resetPassword()
	{
		...
		WebElement newPassword=driver.findElement(By.id("sg.com.blu.android:id/new_password_inputField"));
		newPassword.sendKeys("Admin@12345");
		WebElement confirmPassword=driver.findElement(By.id("sg.com.blu.android:id/confirm_password_inputField"));
		confirmPassword.sendKeys("Admin@12345");
		WebElement submitBtn=driver.findElement(By.id("sg.com.blu.android:id/submit_btn"));
		submitBtn.click();
	...
	public void tc03_deactivateAccount()
	{
		...
		WebElement reason=driver.findElement(By.xpath("//android.widget.RadioGroup[@resource-id='sg.com.blu.android:id/radioGroup']//android.widget.RelativeLayout"));
		reason.click();
