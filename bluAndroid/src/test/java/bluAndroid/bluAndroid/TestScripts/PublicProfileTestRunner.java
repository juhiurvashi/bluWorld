...
public class PublicProfileTestRunner extends BaseClass {
	...
	public void tc01_ViewPublicProfile()
	{
		...
		mds.clickOnMenu();
		ms.clickOnFirstName();
		WebElement title=driver.findElement(By.id("sg.com.blu.android:id/title_tv"));
		Assert.assertEquals(title.getText(), "Public profile","Public profile title displayed");
		WebElement firstName=driver.findElement(By.id("sg.com.blu.android:id/first_name_tv"));
		Assert.assertEquals(firstName.getText(), "Urvashi", "FirstName displayed");
		WebElement bluId=driver.findElement(By.id("sg.com.blu.android:id/blu_id_tv"));
	...
	public void tc02_viewFriendProfileByBluID() throws IOException
	{
		...
		mds.clickOnMenu();
		ms.clickOnFirstName();
		WebElement bluId=driver.findElement(By.id("sg.com.blu.android:id/input_text_et"));
		String bluIDfromPropertiesValue=CommonUtil.getPropertyValue("publicProfile", "bluId");
		bluId.sendKeys(bluIDfromPropertiesValue);
		...
		WebElement bluId1=driver.findElement(By.id("sg.com.blu.android:id/bluIdTextView"));
		Assert.assertEquals(bluId1.getText(), "BLU864092", "bluId displayed");
		List<WebElement> list=driver.findElements(By.xpath("//android.widget.LinearLayout[@resource-id='sg.com.blu.android:id/content']//android.widget.LinearLayout[1]//android.widget.TextView[1]"));
		assertTrue(list.size()>0) ;
	    ...
	    WebElement blockfutureRequest=driver.findElement(By.id("sg.com.blu.android:id/actionTextView"));
	...
	public void tc03_viewFriendProfileByMobile() throws IOException
	{
		...
		mds.clickOnMenu();
		ms.clickOnFirstName();
		WebElement mobile=driver.findElement(By.id("sg.com.blu.android:id/input_text_et"));
		pp.clickOnMobile();
		...
		mobile.sendKeys(mobilefromPropertiesValue);
		WebElement title=driver.findElement(By.id("sg.com.blu.android:id/titleTextView"));
		Assert.assertEquals(title.getText(), "Public profile","Public profile title displayed");
	...
	public void tc05_InvaldMobile()
	{
		...
		WebElement mobileTextField=driver.findElement(By.id("sg.com.blu.android:id/input_text_et"));
		mobileTextField.sendKeys("91235555");
		WebElement error=driver.findElement(By.id("sg.com.blu.android:id/error_tv"));
		Assert.assertEquals(error.getText(), "Member not found.");
	}
	@Test
	...
	public void tc07_unblockMember() throws IOException
	{
		...
		String bluIDfromPropertiesValue=CommonUtil.getPropertyValue("publicProfile", "bluId");
		bluId.sendKeys(bluIDfromPropertiesValue);
		WebElement unblockFutureRequest=driver.findElement(By.id("sg.com.blu.android:id/actionTextView"));
